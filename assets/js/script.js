...
function initAutocomplete() {
  ...
  // serach for zipcode needs to redirect
...
// possibly not the right url for the endpoint that we need, just a filler currently
  fetch('https://maps.googleapis.com/maps/api/js?key=AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg&callback=initAutocomplete&libraries=places&v=weekly', {
    method: 'POST',
